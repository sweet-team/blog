  ...
  <el-table
    ...
    <el-table-column v-for="(column, index) in columns" :width="column.width" :key="column.dataIndex"
      ...
      <template slot-scope="scope">
        ...
        <el-image style="width:80px;height: 80px; border-radius: 50%"  v-if="column.img" :src="scope.row[column.dataIndex]" :preview-src-list="[scope.row[column.dataIndex]]"></el-image>
        <span v-else>
